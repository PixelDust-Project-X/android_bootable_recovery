...
void ScreenRecoveryUI::SetColor(UIElement e) const {
  switch (e) {
    ...
    case UIElement::MENU_SEL_BG:
      gr_color(216, 216, 216, 255); /*light grey*/
      break;
    ...
    case UIElement::SCROLLBAR:
      gr_color(94, 151, 246, 255); /*light blue*/
      break;
    case UIElement::LOG:
...
bool ScreenRecoveryUI::Init(const std::string& locale) {
  ...
  pixeldust_logo_ = LoadBitmap("logo_image");
...
std::unique_ptr<Menu> ScreenRecoveryUI::CreateMenu(const std::vector<std::string>& text_headers,
  ...
  int menu_rows = (ScreenHeight() - margin_height_*2 - gr_get_height(pixeldust_logo_.get()))
